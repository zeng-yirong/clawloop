...
class ToolAgentLoop(AgentLoopBase):
    ...
    async def _handle_generating_state(
        ...
        if looping_repeat_count > 0:
            mask_looping_response = bool_env("NANOCLAW_MASK_LOOPING_RESPONSES", False)
            nanoclaw_record_bad_turn_span(
                agent_data,
                ...
                mask_enabled=mask_looping_response,
            )
            if mask_looping_response and bool_env("NANOCLAW_MASK_ONLY_POSITIVE_ADVANTAGE", False):
                looping_response_mask_candidate = True
            elif mask_looping_response:
